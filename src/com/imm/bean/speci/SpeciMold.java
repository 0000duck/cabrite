...
public class SpeciMold implements iMode {
	...
	public void init() {
		try {
			kvCylinderDiameter = HmiVariableService.getService()
					.getVariable("Mold" + index + ".sv_CylinderData.rCylinderDiameter");
			kvPistonrodDiameter = HmiVariableService.getService()
					.getVariable("Mold" + index + ".sv_CylinderData.rPistonRodDiameter");
			kvNumCylinders = HmiVariableService.getService()
					.getVariable("Mold" + index + ".sv_CylinderData.iNumCylinders");
			kvUserSmallSize = HmiVariableService.getService()
					.getVariable("Mold" + index + ".sv_CylinderData.bUseSmallSize");
			kvMaxSpeedFwd = HmiVariableService.getService().getVariable("Mold" + index + ".sv_rMaxSpeedFwd");
			kvMaxSpeedBwd = HmiVariableService.getService().getVariable("Mold" + index + ".sv_rMaxSpeedBwd");
